...
def getMidCapNiftyExpiryDate(next=0):
    expiry = {
        ...
        datetime.datetime(2024, 6, 3).date(): "24604",
...
# def getSensexExpiryDate(next=0):
#     finnifty_expiry = {
#         datetime.datetime(2024, 3, 15).date(): "24315",
#         datetime.datetime(2024, 3, 22).date(): "24322",
#         datetime.datetime(2024, 3, 29).date(): "24328",
#         datetime.datetime(2024, 4, 5).date(): "24405",
#         datetime.datetime(2024, 4, 12).date(): "24412",
#         datetime.datetime(2024, 4, 19).date(): "24419",
#         datetime.datetime(2024, 4, 26).date(): "24426",
#         datetime.datetime(2024, 5, 3).date(): "24503",
#         datetime.datetime(2024, 5, 10).date(): "24510",
#         datetime.datetime(2024, 5, 17).date(): "24517",
#         datetime.datetime(2024, 5, 24).date(): "24524",
#         datetime.datetime(2024, 5, 31).date(): "24531",
#         datetime.datetime(2024, 6, 7).date(): "24607",
#         datetime.datetime(2024, 6, 14).date(): "24614",
#         datetime.datetime(2024, 6, 21).date(): "24621",
#         datetime.datetime(2024, 6, 28).date(): "24628",
#     }
#
#     today = datetime.datetime.now().date()
#
...
def getFutureFormat(stock, intExpiry):
    if stock in mcx_expiries.keys():
        ...
        return "NSE:"+str(stock)+str(intExpiry)+str('FUT')
